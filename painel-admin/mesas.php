...
<a href="index.php?page=<?php echo $pagina?>&funcao=novo" type="button" class="btn btn-secondary mt-2 mb-4">Nova Mesa</a>
			...
			<form method="post" id="form">
				<div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="descricao" placeholder="Digite aqui a descrição da mesa" name="descricao" value="<?php echo @$descricao; ?>">
                    </div>
