                ...
                <form method="post" id="form">
                    <div class="modal-body">
                        ...
                        <div id="divImgConta" class="mt-4">
                        	<?php 
                        		if(@$arquivo != ""){?>
                        			<img src="../img/<?php echo $oagine ?>/<?php echo @$imagem; ?>" width="170" id="target">
                        	<?php
                        		}else{?>
...
//SCRIPT PARA CHAMADA DA MODAL
    ...
    <script type="text/javascript">
    	function carregarImg(){
    		...
    		var file = document.getElementById('input[type=file]').files[0];
    		...
    		if(resultado[1] == "pdf"){
    			$("#target".attr('src', "../img/<?php echo $pagina ?>/pdf.png"));
    			return;
    		}
